...
const Banner = () => {
  ...
  return (
    ...
    >
      <div className="short-intro p-2 mt-20  flex flex-col items-center">
        ...
        <p className="text-xl text-center font-semibold text-black positi">
          Let&apos;s make something special.
        </p>

        <button
          type="button"
          className="project-btn px-4 py-3 mt-24 bg-blue-600 rounded-md text-white outline-none focus:ring-4 shadow-lg transform active:scale-y-75 transition-transform flex w-80 items-center"
        >
